...
function BannerCarousel({ banners = dummyBanners }: BannerCarouselPropsType) {
  ...
  return (
    <div className={`${styles.wrapper} pt-[60px]`}>
      <Slider {...settings} ref={sliderRef}>
        {banners.map(banner => (
          <div
            key={banner}
            className='relative h-[369px] cursor-pointer rounded-lg bg-background-secondary overflow-hidden outline-none'
          >
